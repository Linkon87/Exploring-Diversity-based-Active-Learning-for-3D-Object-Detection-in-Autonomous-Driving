...
def nuscenes_data_prep(
    ...
    if load_augmented is None:
        ...
        nuscenes_converter.create_nuscenes_infos(
            root_path, info_prefix, budget=budget,buffer_path=buffer_path,version=version, max_sweeps=max_sweeps,
        )
...
parser.add_argument(
    "--budget", type=int, required=True, help="AL budget"
)
parser.add_argument(
    "--buffer_path", type=str, required=True, help="selected info idx buffer path"
)
