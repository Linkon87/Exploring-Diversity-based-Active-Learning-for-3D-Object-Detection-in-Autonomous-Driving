...
db_sampler = dict(
    type="GT-AUG",
    enable=False,
    db_info_path="/home/st2000/data/Datasets/nuScenes/train/dbinfos_train_10sweeps_withvelo_uwe.pkl",
...
train_anno = "/home/st2000/data/Datasets/nuScenes/train/infos_train_10sweeps_withvelo_uwe.pkl"
...
selector = dict(
    type="UWESelector",
    budget=4800,
    buffer_file="/home/st2000/data/buffers/uwe.json",
