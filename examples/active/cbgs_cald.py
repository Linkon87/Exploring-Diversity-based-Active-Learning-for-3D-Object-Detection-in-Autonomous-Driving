...
db_sampler = dict(
    type="GT-AUG",
    enable=False,
    db_info_path="/home/st2000/data/Datasets/nuScenes/train/dbinfos_train_10sweeps_withvelo_cald.pkl",
...
val_preprocessor = dict(
    ...
    gt_loc_noise=[0.6, 0.6, 0.6],
    gt_rot_noise=[0.4, 0.4],
    global_rot_noise=[-0.7925, 0.7925],
    global_scale_noise=[0.5, 1.5],
    global_rot_per_obj_range=[0.5, 1.5],
    global_trans_noise=[0.2, 0.2, 0.2],
    gt_drop_percentage=0.0,
    gt_drop_max_keep_points=15,
    class_names=class_names,
...
train_anno = "/home/st2000/data/Datasets/nuScenes/train/infos_train_10sweeps_withvelo_cald.pkl"
...
selector = dict(
    type="CaldSelector",
    budget=4800,
    buffer_file="/home/st2000/data/buffers/cald.json",
