...
data_root = "/home/st2000/nuscenes/train"
...
db_sampler = dict(
    ...
    db_info_path="/home/st2000/nuscenes/train/dbinfos_train_10sweeps_withvelo_feature.pkl",
...
train_anno = "/home/st2000/data/Datasets/nuScenes/train/seed0/infos_train_10sweeps_withvelo_feature.pkl"
val_anno = "/home/st2000/data/Datasets/nuScenes/train/infos_val_10sweeps_withvelo.pkl"


# train_anno = "data/nuScenes/infos_train_10sweeps_withvelo_random.pkl"
...
selector = dict(
    type="SpatialTemporalFeatureSelector",
    budget=1200,
    buffer_file="/home/st2000/data/buffers/spatial_temporal_feature.json",
    infos_origin=train_anno,
    logs_file="/home/st2000/data/Datasets/nuScenes/train/v1.0-trainval/log.json",
)
...
workflow = [('train', train_epochs), ('val', 1)]
