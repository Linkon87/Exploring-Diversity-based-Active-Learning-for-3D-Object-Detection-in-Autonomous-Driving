...
model = dict(
    ...
    backbone=dict(
        type="FPNSpMiddleResNetFHD", num_input_features=5, ds_factor=8, norm_cfg=norm_cfg,
    ),
    neck=dict(
        type="RPN",
        layer_nums=[5, 5],
...
val_dataset_type = "NuScenesDataset"
nsweeps = 10
# data_root = "data/nuScenes"
data_root = "/home/st2000/data/Datasets/nuScenes/train"

db_sampler = dict(
    type="GT-AUG",
    enable=False,
    # db_info_path="data/nuScenes/dbinfos_train_10sweeps_withvelo.pkl",
    db_info_path="/home/st2000/data/Datasets/nuScenes/train/dbinfos_train_10sweeps_withvelo.pkl",
...
train_pipeline = [
    dict(type="LoadPointCloudFromFile", dataset="NuScenesDataset"),
...
train_anno = "/home/st2000/data/Datasets/nuScenes/train/infos_train_10sweeps_withvelo.pkl"
val_anno = "/home/st2000/data/Datasets/nuScenes/train/infos_val_10sweeps_withvelo.pkl"
# train_anno = "data/nuScenes/infos_train_10sweeps_withvelo.pkl"
# val_anno = "data/nuScenes/infos_val_10sweeps_withvelo.pkl"
test_anno = None

sample_ratio = 0.1
active_buffer = "test.json" #
data = dict(
    samples_per_gpu=3,
    workers_per_gpu=6,
    train=dict(
...
load_from = None
estimator_load_from = None
resume_from = None
estimator_resume_from = None
train_epochs = 2
estimator_train_epochs = 5 #
total_epochs = train_epochs + estimator_train_epochs #
workflow = [('train', train_epochs), ("estimator_train", estimator_train_epochs), ('val', 1)]
