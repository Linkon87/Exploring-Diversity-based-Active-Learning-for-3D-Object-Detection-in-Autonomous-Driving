...
def parse_args():
    ...
    parser.add_argument("--config", help="train config file path",default='examples/active/cbgs_cald.py')

    ####  modify val_preprocessor in examples/active/cbgs_cald.py to get different aug result

    parser.add_argument("--work_dir", help="the dir to save logs and models")
    parser.add_argument(
        "--checkpoint", default='/home/st2000/data/work_dir/seed42/NUSC_CBGS_random_600_20221127-184253/epoch_20.pth',help="the dir to checkpoint which the model read from"
    )
    parser.add_argument(
        "--txt_result",
        type=bool,
...
def main():
    ...
    for i, data_batch in enumerate(data_loader):
            with torch.no_grad():
                ...
                del data_batch
                preds, fpn_feats = model(example, return_loss=False, estimate=True)
