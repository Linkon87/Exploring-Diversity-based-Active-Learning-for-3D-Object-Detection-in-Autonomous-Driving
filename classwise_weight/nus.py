...
from classwise_weight.nuscom import (
...
class NuScenesDataset_(PointCloudDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(NuScenesDataset_, self).__init__(
        ...
        self._num_point_features = NuScenesDataset_.NumPointFeatures
