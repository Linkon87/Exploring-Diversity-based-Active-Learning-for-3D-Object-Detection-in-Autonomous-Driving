...
class BadgeSelector(BaseSelector):
    def __init__(
            ...
            weighted_feat_path: str = '/home/st2000/data/buffers/badge_feat.pt',
            distance_store_file: str = "/home/st2000/data/buffers/badge_distance_map.npy",
            p: int = 2,
        ...
        for i, data_batch in enumerate(self.dataloader):
            with torch.no_grad():
                ...
                for b_i, (pred, pillar_feat) in enumerate(zip(preds, pillar_feats)):
                    ...
                    entropy_weighted_feature = pillar_feat * (entropy.mean())#.cpu())
