...
class Trainer(object):
    ...
    def batch_processor_inline(self, model, data, train_mode, finetune=False, **kwargs):
        ...
        if train_mode:
            losses = model(example, return_loss=True, finetune=finetune)
    ...
    def train(self, data_loader, epoch, **kwargs):
        ...
        for i, data_batch in enumerate(data_loader):
            ...
            if self.lr_scheduler is not None and not kwargs.get("finetune", False):
    ...
    def finetune(self, data_loader, epoch, **kwargs):
        ...
        for i, data_batch in enumerate(data_loader):
            ...
            #                                **kwargs)
            outputs = self.batch_processor_inline(
                self.model, data_batch, train_mode=True, finetune=True, **kwargs
            )
